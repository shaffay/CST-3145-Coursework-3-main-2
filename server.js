...
MongoClient.connect("mongodb+srv://shaffaybajwa:lwKs3ekTtkHuG5eI@cluster0.ylb1s9u.mongodb.net/", (err, client) => {
    if (err) {
        console.error('Error connecting to the database:', err);
    } else {
        const db = client.db('dbcwi2');
        ...
        app.post('/collection/orders', (req, res) => {
            ...
            const ordersCollection = client.db(dbcwi2).collection('order');
